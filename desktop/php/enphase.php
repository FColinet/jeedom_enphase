	...
	<div class="col-lg-2 col-md-3 col-sm-4">
		<div class="bs-sidebar">
			<ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
				<a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter un champ photovoltaïque}}</a>
...
?>
 	...
 	<div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
		<legend><i class="fa fa-table"></i> {{Mes champs photovoltaïques}}</legend>
...
foreach ($eqLogics as $eqLogic) {
	...
	echo '<img src="plugins/enphase/plugin_info/enphase_icon.png" height="105" width="95" />';
	echo "<br>";
...
<?php include_file('desktop', 'enphase', 'js', 'enphase');?>
